            ...
            <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
                <center>
                    <table cellspacing="0" cellpadding="0" width="600" class="w320">
                        <tr>
                            <td class="header-lg">
                                Harap Segera Melakukan Pengecekan
                            </td>

                        </tr>
                        <tr>
                            <td class="free-text">
                                Dengan No Invoice: <span style="color: #1E90FF; font-weight:bold;"><?php echo $b['id_order'] ?></span> Atas nama <span style="color: #1E90FF; font-weight:bold;"><?php echo $b['atasnama'] ?></span></div>
                            </td>
                        </tr>
                        <tr>
                            <td class="mini-block-container">
                          ...
                          <![endif]--><a href="<?= base_url('Administrator'); ?>" style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Lihat Konfirmasi</a></div>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
