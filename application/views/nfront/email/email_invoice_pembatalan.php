            ...
            <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
                <center>
                    <table cellspacing="0" cellpadding="0" width="600" class="w320">
                        ...
                        <tr>
                            <td class="free-text">
                                Pembatalan tiket Anda sudah kami konfirmasi pengembalian dana sebesar 30% dari total harga sesuai dengan kebijakan perusahaan sudah kami tranfers ke No.rekening Anda.
                            </td>
                        </tr>
                        <tr>
                            <td class="mini-block-container">
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    <td style="padding-bottom: 30px;">
                                                        ...
                                                        ?>
                                                        Pengembalian dana sebesar <?php echo 'Rp. ' . number_format($dana); ?>ke No.rekening <span style="font-weight:700; color: #ff6f6f; font-size: 18px;"><?php echo $b['no_rek'] ?></span> Atas Nama <span style="font-weight:700; color: #ff6f87; font-size: 18px;"><?php echo $b['nama_rekening'] ?></span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="code-block">
                                                        ID Invoice: <?php echo $b['id_order'] ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="button">
