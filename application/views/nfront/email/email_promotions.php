             ...
             <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
                 <center>
                     <table cellspacing="0" cellpadding="0" width="600" class="w320">
                         <tr>
                             <td class="header-lg">
                                 Welcome To Sumbawa Tour Agency
                             </td>
                         </tr>
                         <tr>
                             <td class="free-text">
                                                     ...
                                                     <tr>
                                                         <td class="block-rounded">
                                                             <table cellpadding="0" cellspacing="0" width="100%">
                                                                 <tr>
                                                                     <td class="info-img">
                                                                         <a href="<?php echo base_url() . 'paket_tour/detail_paket/' . $idberita; ?>"><img class="info-img" src="<?php echo base_url() . 'assets/gambars/' . $gbr; ?>" style="height: 250px;" alt="img" /></a>
                                                                     </td>
                                                                 </tr>
                                                                 <tr>
                                                                         ...
                                                                         <table cellspacing="0" cellpadding="0" width="100%">
                                                                             <tr>
                                                                                 <td style="text-align:left; width:155px">
                                                                                     <a href=""><span class="header-sm"><?= $judul; ?></span></a><br />
                                                                                     Rp. <?= number_format($hargadewasa); ?>/ ORANG
                                                                                 </td>
                                                         ...
                                                         <tr>
                                                             <td align='center' style='font-size:0px;padding:10px 25px;padding-bottom:5px;word-break:break-word;'>
                                                                 <div style='color:#4d4d4d;font-family:Oxygen, Helvetica neue, sans-serif;font-size:24px;font-weight:700;line-height:30px;text-align:center;'>
                                                                     Tempat Wisata Paling Keren di Indonesia
                                                                 </div>
                                                             </td>
                                                         </tr>
                                                         <tr>
                                                                             ...
                                                                             <tbody>
                                                                                 <tr>
                                                                                     <td style='width:240px;'>
                                                                                         <img alt='Descriptive Alt Text' height='auto' src='<?php echo base_url() . 'assets/gambars/' . $gbr; ?>' style='border:none;border-radius:5px;display:block;font-size:13px;height:auto;outline:none;text-decoration:none;width:100%;' width='240' />
                                                                                     </td>
                                                                                 </tr>
                                                                             </tbody>
                                                                         </table>
