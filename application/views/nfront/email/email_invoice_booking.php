...
<head>
    ...
    <title>Sumabawa Tour Invoice</title>
    ...
    <table align="center" cellpadding="0" cellspacing="0" class="container-for-gmail-android" width="100%">
        ...
        <tr>
            <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
                <center>
                    <table cellspacing="0" cellpadding="0" width="600" class="w320">
                        ...
                        <tr>
                            <td class="free-text">
                                <b>Yth. <?= $b['nama']; ?> </b> <br>
                                Reservasi paket tour wisata Anda telah sukses dikonfirmasi. E-tiket ANda terdapat di attachment.
                            </td>
                        </tr>
                        <tr>
                            <td class="button">
              ...
              <![endif]--><a href="<?= base_url('paket_tour/booking'); ?>" style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:60px;text-align:center;text-decoration:none;width:175px;-webkit-text-size-adjust:none;mso-hide:all;">Lihat Di website</a></div>
                            </td>
                        </tr>
                        <tr>
                            <td class="w320">
                                                ...
                                                <tr>
                                                    <td class="mini-block-padding">
                                                        <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                                                            <tr>
                                                                <td class="mini-block">
                                                                    <span class="header-md">Data Pesan Tiket</span><br />
                                                                    <b>Paket:</b>
                                                                    <?php echo $b['nama_paket']; ?>\<br />
                                                                    <b>Alamat Pemesan:</b><br />
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                                                            <tr>
                                                                <td class="mini-block">
                                                                    ...
                                                                    <br />
                                                                    <span class="header-sm">Kode Booking</span> <br />
                                                                    <span class="header-md" style="color: #1E90FF; font-weight:bold;" class="header-sm"><?php echo $b['kode_booking'] ?> </span>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
