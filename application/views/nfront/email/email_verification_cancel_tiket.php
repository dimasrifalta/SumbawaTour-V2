            ...
            <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
                <center>
                    <table cellspacing="0" cellpadding="0" width="600" class="w320">
                        ...
                        <tr>
                            <td class="free-text">
                                There's one last step until your tiket cancled is 100% cancle. We need you to comfimation your cancel tiket.
                            </td>
                        </tr>
                        <tr>
                            <td class="mini-block-container">
                          ...
                          <![endif]--><a href="<?= base_url('pembatalan/verify?email=' . $email . '&token=' . $token . ''); ?>" style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Cancel Tiket</a></div>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
