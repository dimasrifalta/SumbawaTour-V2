...
if ($b['status'] ==  "" or $b['status'] == "belum_bayar") { ?>
        ...
        <div class="container">
            <div class="details clearfix">
                ...
                <div class="data right">
                    <div class="title">HARAP SEGERA MELAKUKAN KONFIRMASI PEMBAYARAN</div>
                    <div class="date">
    ...
    <footer>
        <div class="container">
            <div class="thanks">Harap segera melakukan pembayaran sebesar <?php echo 'Rp. ' . number_format($b['total']); ?> Ke Bank <?php echo $b['bank']; ?> No Rekning : <?php echo $b['norek']; ?> Atas Nama : <?php echo $b['atasnama']; ?></div>
            <div class="notice">
                <!-- <div>NOTICE:</div>
                ...
                <br>
                <div>
                    <p><a href="<?php echo base_url() . 'konfirmasi/index/' . $b['id_order']; ?>" class="btn btn-primary py-1 px-2 ">Konfirmasi Pembayaran</a> </p>
                </div>
            </div>
