            ...
            <div class="container">
                <div class="signin-content">
                    ...
                    <div class="signin-form">
                        ...
                        <form class="register-form" id="login-form" method="post" action="<?= base_url('auth/forgotPassword'); ?>">
                            <div class="form-group">
                                <label for="your_name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="email" id="email" placeholder="Enter your email" value="<?= set_value('email'); ?>">
